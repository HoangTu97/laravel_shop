                    ...
                    <div class="panel-body">
                        <form role="form" action="" method="POST">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Password Confirm" name="txtRePassword" type="password" value="" >
                                </div>
                                <button type="submit" class="btn btn-lg btn-success btn-block">Register</button>
                                <a href="{!! url('login') !!}" class="btn btn-lg btn-default btn-block">Login</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
